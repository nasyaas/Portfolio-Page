          ...
          .append(
            $(
              '<svg xmlns="http://www.w3.org/2000/svg" version="1.1" viewBox="0 0 194 186" class="circliful">' +
                ...
                '<circle class="circle" cx="100" cy="100" r="57" fill="none" stroke="' +
        ...
        if (settings.percentages.length > 0) {
          ...
          if (settings.beforePercent !== "") {
            if (settings.beforePercent.charAt(0) === "f") {
              beforePercent =
                '<tspan class="icon before-percent">' +
                "&#x" +
                settings.beforePercent +
                " </tspan>";
            } else {
              beforePercent =
                '<tspan class="before-percent">' +
                settings.beforePercent +
                " </tspan>";
            }
          }
            ...
            .append(
              $(
                '<svg xmlns="http://www.w3.org/2000/svg" version="1.1" viewBox="0 0 194 186" class="circliful">' +
                  ...
                  '" stroke-width="' +
                  settings.foregroundBorderWidth +
                  '" stroke-dasharray="0,20000" transform="rotate(-90,100,100)" stroke-linecap="' +
                  settings.strokeLinecap +
                  '" />' +
                  '<circle cx="100" cy="100" r="' +
                  settings.pointSize +
